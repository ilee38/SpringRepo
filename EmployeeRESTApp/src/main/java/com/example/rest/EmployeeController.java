...
public class EmployeeController {
    ...
    public ResponseEntity getByTitle(@PathVariable String title){
    	...
    	List<Employee> byTitleList = null;
    	byTitleList = edao.getByTitle(title);
    	
    	if(byTitleList != null){
    		return new ResponseEntity<>(byTitleList, HttpStatus.OK);
    	}else{
    		return new ResponseEntity<>(null, HttpStatus.NOT_FOUND);
    	}
    }
    ...
    public ResponseEntity getByDept(@PathVariable String dept){
    	...
    	List<Employee> byDeptList = null;
    	byDeptList = edao.getByDept(dept);
    	
    	if(byDeptList != null){
    		return new ResponseEntity(byDeptList, HttpStatus.OK);
    	}else{
    		return new ResponseEntity(null, HttpStatus.NOT_FOUND);
    	}
    }
